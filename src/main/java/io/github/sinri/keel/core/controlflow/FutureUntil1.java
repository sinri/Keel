 ...
 *
 * @since 2.8
 * @deprecated might cause the warning of Thread Blocking
 */
@Deprecated(since = "2.9", forRemoval = true)
public class FutureUntil1 {
...
//    }
    ...
    private FutureUntil1(Supplier<Future<Boolean>> singleRecursionForShouldStopSupplier) {
    ...
    public static Future<Void> call(Supplier<Future<Boolean>> singleRecursionForShouldStopSupplier) {
        return new FutureUntil1(singleRecursionForShouldStopSupplier).start();
    }
