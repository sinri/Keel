...
public class KeelMySQLKit {
    ...
    public void executeInTransaction(
        ...
        pool.getConnection(sqlConnectionAsyncResult -> {
            ...
            sqlConnection.begin(transactionAsyncResult -> {
                ...
                transactionResultFuture.onSuccess(result -> {
                    transaction.commit(commitAsyncResult -> {
                    ...
                    transaction.rollback(rollbackAsyncResult -> {
    ...
    public Future<Long> executeSqlForLastInsertedID(
    ...
    public Future<Integer> executeSqlForAffectedRowCount(
            SqlConnection sqlConnection,
            String sqlTemplate,
            Tuple data,
            boolean useRecover
